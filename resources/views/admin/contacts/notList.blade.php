...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Müraciətlər /</span>Baxılmamış Müraciətlər</h4>
            <!-- Basic Bootstrap Table -->
            <div class="card">
                <div class="card-body">
                    <table class="table nowrap data-table" id="notcontacts">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Mesajı</th>
    ...
    <script>
        $(document).ready(function () {
            $('#notcontacts').DataTable({
                ...
                ajax: '{!! route('admin.contacts.notList') !!}',
