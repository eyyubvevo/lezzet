...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Açar Sözlər /</span>Bütün Açar Sözlər</h4>
            <!-- Basic Bootstrap Table -->
            <div class="card">
                <div class="card-body">
                    <table class="table nowrap data-table" id="tags">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Adı</th>
        ...
        $(document).ready(function () {
            $('#tags').DataTable({
                ...
                language: {
                    ...
                    "sInfo":          " _TOTAL_ açar sözdən _START_ - _END_ arasındakı açar sözlər göstərılır",
                    "sInfoEmpty":     "Açar söz yoxdur",
                    "sInfoFiltered":  "( _MAX_ açar söz içindən axtarış)",
                    "sInfoPostFix":   "",
                    "sInfoThousands": ",",
                    "sLengthMenu":    "Səhifədə _MENU_ açar söz göstər",
                    "sLoadingRecords": "Yüklənir...",
                    "sProcessing":    "İşlənir...",
                    "sSearch":        "Axtar:",
                    "sZeroRecords":   "Uyğun gələn açar söz tapılmadı",
                    "oPaginate": {
                        "sFirst":    "İlk",
                        "sLast":     "Son",
                        "sNext":     "Növbəti",
