...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tərəfdaşlar /</span>Bütün Tərəfdaşlar</h4>
            <!-- Basic Bootstrap Table -->
            <div class="card">
                <div class="card-body">
                    <table class="table nowrap data-table" id="partners">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Şəkli</th>
        ...
        $(document).ready(function () {
            $('#partners').DataTable({
                ...
                language: {
                    ...
                    "sInfo":          " _TOTAL_ tərəfdaşdən _START_ - _END_ arasındakı tərəfdaşlər göstərılır",
                    "sInfoEmpty":     "Tərəfdaş yoxdur",
                    "sInfoFiltered":  "( _MAX_ tərəfdaş içindən axtarış)",
                    "sInfoPostFix":   "",
                    "sInfoThousands": ",",
                    "sLengthMenu":    "Səhifədə _MENU_ tərəfdaş göstər",
                    "sLoadingRecords": "Yüklənir...",
                    "sProcessing":    "İşlənir...",
                    "sSearch":        "Axtar:",
                    "sZeroRecords":   "Uyğun gələn tərəfdaş tapılmadı",
                    "oPaginate": {
                        "sFirst":    "İlk",
                        "sLast":     "Son",
                        "sNext":     "Növbəti",
