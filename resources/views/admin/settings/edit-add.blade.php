            ...
            <div class="row">
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form
                                action="{{ isset($setting) ? route('admin.settings.update',['id' => $setting->id]) : route('admin.settings.store')}}"
                                method="post"
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="type">Parametr Tipi</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" id="type" name="type" @if(isset($setting)) disabled
                                                @else required @endif>
                                            <option>Zəhmət olmazsa seçin</option>
                                            <option @if(isset($setting) && $setting->type == 'text') selected
                                                    @endif value="text">
                                                Mətn
                                            </option>
                                            <option @if(isset($setting) && $setting->type == 'image') selected
                                                    @endif value="image">
                                                Şəkil
                                            </option>
                                            <option @if(isset($setting) && $setting->type == 'ckeditor') selected
                                                    @endif value="ckeditor">
                                                CkEditor
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div style="display: none;" class="row mb-3" id="text-input">
                                ...
                                <div style="display: none;" class="row mb-3" id="image-input">
